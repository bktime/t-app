  ...
  try {
    ...
    return json({
      ...
      data: {
        date,
        has_checkin:  !!checkin,
        // ✅ แก้ไข: checkout_type = auto ถือว่ายังไม่ checkout
        has_checkout: !!(checkout && checkout.checkout_type !== 'auto'),
        checkin,
        checkout,    // ← ยังส่ง object กลับเผื่อ frontend แสดง "ลงอัตโนมัติ"
        request:    requestInfo,
